...
module CocoaDialog
	...
	CD = File.join(File.expand_path(File.dirname(__FILE__)), "CocoaDialog.app/Contents/MacOS/CocoaDialog") # this is the bundled CocoaDialog.app
	#CD = "/Applications/CocoaDialog.app/Contents/MacOS/CocoaDialog" # this is the regularly installed CocoaDialog app
